...
export class WaterMesh extends BufferedMesh {
  ...
  setPackage(pkg) {
    ...
    const lavaTexture = textureLoader.load(`${baseUrl}../heightfield/water-effect/assets/textures/lava6.png`);
    lavaTexture.wrapS = lavaTexture.wrapT = THREE.RepeatWrapping;

    const lavaNormalTexture = textureLoader.load(`${baseUrl}../heightfield/water-effect/assets/textures/lava-normal6.png`);
    lavaNormalTexture.wrapS = lavaNormalTexture.wrapT = THREE.RepeatWrapping;
    const lavaEmissiveTexture = textureLoader.load(`${baseUrl}../heightfield/water-effect/assets/textures/lava-emissive6.png`);
    lavaEmissiveTexture.wrapS = lavaEmissiveTexture.wrapT = THREE.RepeatWrapping;
    const lavaHeightTexture = textureLoader.load(`${baseUrl}../heightfield/water-effect/assets/textures/lava-height6.png`);
    lavaHeightTexture.wrapS = lavaHeightTexture.wrapT = THREE.RepeatWrapping;

    const flowmapTexture = textureLoader.load(`${baseUrl}../heightfield/water-effect/assets/textures/flowmap.png`);
    flowmapTexture.wrapS = flowmapTexture.wrapT = THREE.RepeatWrapping;

    const noiseTexture = textureLoader.load(`${baseUrl}../heightfield/water-effect/assets/textures/noise.jpg`);
    noiseTexture.wrapS = noiseTexture.wrapT = THREE.RepeatWrapping;

    
    this.material.uniforms.mainTexture.value = lavaTexture;
    this.material.uniforms.lavaEmissiveTexture.value = lavaEmissiveTexture;
    this.material.uniforms.lavaHeightTexture.value = lavaHeightTexture;
    this.material.uniforms.lavaNormalTexture.value = lavaNormalTexture;
    this.material.uniforms.flowmapTexture.value = flowmapTexture;
